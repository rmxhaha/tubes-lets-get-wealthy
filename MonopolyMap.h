...
void save_game(FILE*,MonopolyMap map, boolean roll, boolean reroll, boolean upgraded);

void load_game(FILE*,MonopolyMap* map, boolean* roll, boolean* reroll, boolean *upgraded);
